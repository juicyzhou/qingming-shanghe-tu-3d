...
// 掌柜站位（松散布局：两岸店铺 x±14；b.z - facing*hd + 1.4 即默认门口内侧）
const KEEPER_POS = {
  tavern: [14.0, 9.4], tea: [-14.0, 11.9], inn: [14.0, 20.9],
  clinic: [-14.0, 1.9], cloth: [14.0, 49.4], incense: [-14.0, 65.9],
  general: [-14.0, 21.9], snack: [14.0, 60.9], butcher: [-14.0, 41.9], rice: [-14.0, 53.4],
};
